...
public class BSTwithTraversalOrder<Key extends Comparable<Key>, Value> {
    ...
    private void printLevelOrder(Node node, int level) {
        if (node == null) return;
        if (level == 0) StdOut.print(node.key + " ");
        else if (level > 0) {
    ...
    public static void main(String[] args) {
        BSTwithTraversalOrder<String, Integer> st = new BSTwithTraversalOrder<String, Integer>();
